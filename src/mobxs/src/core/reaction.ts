...
export class Reaction implements IDerivation, IReactionPublic {
    ...
    constructor(
        ...
        private onInvalidate_: () => void,//传入自定义的reactionRunner
...
export function runReactions() {
    ...
    console.log('在runReactions内部globalState',`globalState.inBatch:${globalState.inBatch}`,`globalState.isRunningReactions:${globalState.isRunningReactions}`)
...
function runReactionsHelper() {
    ...
    let iterations = 0
    console.log('执行reaction',allReactions)
